<template>
  <v-app :dark="dark">
    ...
    <v-navigation-drawer
      ...
      app
    >
      <v-toolbar flat class="transparent" color="blue-grey darken-1">
        <v-list class="pa-0">
          <v-list-tile avatar>
            <v-list-tile-avatar>
              <img src="../assets/cat07.jpg">
            </v-list-tile-avatar>
            <v-list-tile-content>
              <v-list-tile-title style="color: white">Nerea</v-list-tile-title>
            </v-list-tile-content>
          </v-list-tile>
        </v-list>
      </v-toolbar>
    ...
    <v-toolbar
      app
      dark
      :color="dark ? 'secondary' : 'blue-grey darken-1'"
    >
      <!-- 隐藏左侧菜单的按钮-->
